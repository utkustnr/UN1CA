...
GEN_CONFIG_FILE()
{
...

    {
        ...
        echo "TARGET_HAS_CUSTOM_CAMXML=\"${TARGET_HAS_CUSTOM_CAMXML:=?}\""
        ...
        echo "SOURCE_MDNIE_SUPPORT_HDR_EFFECT=\"${SOURCE_MDNIE_SUPPORT_HDR_EFFECT:?}\""
        echo "TARGET_MDNIE_SUPPORT_HDR_EFFECT=\"${TARGET_MDNIE_SUPPORT_HDR_EFFECT:?}\""
